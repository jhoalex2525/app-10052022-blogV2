...
export default function Pie() {
    return(
                ...
                <div className="w3-third">
                    ...
                    <ul className="w3-ul w3-hoverable">
                        <li className="w3-padding-16">"
                            <img src={imagen1} className="w3-left w3-margin-right" style={{width:"50px"}}/>
                            <span className="w3-large">Lorem</span><br/>
                            <span>Sed mattis nunc</span>
                        </li>
                        <li className="w3-padding-16">
                            <img src={imagen2} className="w3-left w3-margin-right" style={{width:"50px"}}/>
        ...
        <div className="w3-black w3-center w3-padding-24">Powered by <img src={logo} style={{width:"50px"}}/> <a href="https://www.w3schools.com/w3css/default.asp" title="W3.CSS" target="_blank" className="w3-hover-opacity">Jossy</a></div>
        </>
